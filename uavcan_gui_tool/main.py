...
from .widgets.vtol_information.vtol_node_window import VTOLWindow
from .widgets.vtol_information.vtol_widget import VTOLWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, node, iface_name):
        ...
        self.setCentralWidget(make_splitter(Qt.Horizontal,
                                            make_vbox(make_splitter(Qt.Horizontal,
                                                                    self._local_node_widget,
    ...
    def _show_vtol_window(self):
        w = VTOLWindow(self, self._node, self._show_node_window, self._dynamic_node_id_allocation_widget)
